...
class Gamble_vs_Safe(Page):
    form_model = 'player'
    form_fields = ['Q0_gamble', 'Q1_gamble', 'Q2_gamble', 'Q3_gamble', 'Q4_gamble', 'Q5_gamble', 'Q6_gamble', 'Q7_gamble', 'Q8_gamble', 'Q9_gamble', 'Q10_gamble', 'Q11_gamble', 'Q12_gamble', 'Q13_gamble', 'Q14_gamble', 'Q15_gamble']
    def vars_for_template(self):
        return dict(
        number_balls_total=Constants.number_balls_red+Constants.number_balls_black,
        endowment_int=int(Constants.endowment)

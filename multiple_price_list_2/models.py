...
class Constants(BaseConstants):
    name_in_url = 'multiple_price_list_2'
    players_per_group = None
    num_rounds = 1
    increment = c(10)
    endowment = c(100)
    number_balls_red = 10
    number_balls_black = 10
    num_questions = 11
...
class Player(BasePlayer):
    ...
    Q10_gamble = models.BooleanField(choices=[[True, 'Urn Gamble'], [False, '100 tokens']], initial=False, widget=widgets.RadioSelectHorizontal)
    ...
    def set_payoffs(self):
        ...
        answers = [self.Q0_gamble, self.Q1_gamble, self.Q2_gamble, self.Q3_gamble, self.Q4_gamble, self.Q5_gamble, self.Q6_gamble, self.Q7_gamble, self.Q8_gamble, self.Q9_gamble, self.Q10_gamble]
